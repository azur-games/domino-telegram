...
export class DepositSuccessContent extends Sprite {
    ...
    createChildren(): void {
        ...
        this.receivedText = new LanguageText({key: "You have received a ", fontSize: 36, fill: 0x83A1F8});
        this.valueText = new LanguageText({key: CurrencyConverter.nanotonToUSD(parseInt(this.nanotons)) + "$", fontSize: 36});
    }
